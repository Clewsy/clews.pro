...
<!-- Above here can be copied for a consistent header across pages -->
		<div id="page">
			...
			<table class="gallery">
				<tr>
					<td class="align-left"><a href="photos/led_matrix_01.jpg"><img class="photo" src="photos/small_led_matrix_01.jpg" alt="Front view - 20x5 matrix." /></a></td>
					<td class="align-right"><a href="photos/led_matrix_02.jpg"><img class="photo" src="photos/small_led_matrix_02.jpg" alt="Rear view - proto-board." /></a></td>
				</tr>
				<tr>
					<td class="align-left"><a href="photos/led_matrix_03.jpg"><img class="photo" src="photos/small_led_matrix_03.jpg" alt="Side view - ATMEGA8535." /></a></td>
					<td class="align-right"><a href="photos/led_matrix_04.jpg"><img class="photo" src="photos/small_led_matrix_04.jpg" alt="Powered up - still works!" /></a></td>
				</tr>
				<tr>
					<td class="align-left"><a href="photos/led_matrix_05.gif"><img class="photo" src="photos/small_led_matrix_05.gif" alt="Clock mode." /></a></td>
					<td class="align-right"><a href="photos/led_matrix_06.gif"><img class="photo" src="photos/small_led_matrix_06.gif" alt="Text mode." /></a></td>
				</tr>
				<tr>
					<td class="align-left"><a href="photos/led_matrix_07.jpg"><img class="photo" src="photos/small_led_matrix_07.jpg" alt="Old notes - matrix configuration." /></a></td>
					<td class="align-right"><a href="photos/led_matrix_08.jpg"><img class="photo" src="photos/small_led_matrix_08.jpg" alt="Old notes - 3x 74HC138 configuration." /></a></td>
				</tr>
			</table>
		</div>
	</body>
