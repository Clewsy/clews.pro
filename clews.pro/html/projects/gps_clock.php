...
<!-- Above here can be copied for a consistent header across pages -->
		<div id="page">
			...
			<p>The schematic and PCB CAD files were developed with <A href="https://kicad.org/">KiCad</a>.  The code was written in C and developed using <a href="https://atom.io/">Atom</a>.  All these files are included in the <a href="https://gitlab.com/clewsy/gps_clock">gitlab repository</a>.</p>
