...
<!-- Above here can be copied for a consistent header across pages -->
		<div id="page">
			...
			<p>The project is actually an iteration on a similar project (rev_1) created in 2014.  Rev_1 used single-sided hand-etched PCBs and was finished with a much more "rustic" enclosure (stained pine).  Rev_2 has a number of newer features and improvements, notable better firmware, hardware and woodwork (i.e. everything).</p>
			<p>Note, by default, the clock boots into a mode that displays date/time in <a href="https://en.wikipedia.org/wiki/ISO_8601">ISO-8601</a> format.  The EPOCH time display mode isn't super intuitive and was really just implemented to amuse myself.</p>
			<p>More recently, I had some more display board PCBs fabricated, this time with a correction.  The previous iteration had a de-coupling on one of the <a href="https://www.maximintegrated.com/en/products/power/display-power-control/MAX7219.html">MAX-7219</a> chips that wasn't grounded.  I also tried out an alternative fabricator, this time going with <a href="https://jlcpcb.com/">JLCPCB</a> and having the boards fabricated in slick black.</p>
			<hr />
