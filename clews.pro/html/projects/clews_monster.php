...
<!-- Above here can be copied for a consistent header across pages -->
		<div id="page">
			...
			<p><a href="clews_monster.php">clews.monster</a> is another site I created, this time to quickly set up some personal services and experiment with <a href="https://github.com/linuxserver/docker-swag">SWAG</a> (Secure Web Application Gateway) for reverse proxy/certbot and <a href="https://hub.docker.com/r/authelia/authelia">authelia</a> for authentication.</a></p>
			...
			<p>The <a href="https://gitlab.com/clewsy/clewsy_ansible/-/blob/master/roles/monster/files/www/index.html">index page</a> remains accessible, but authelia prevents access to the sub-domain pages without the correct credentials.</p>
			<p>Currently clews.monster is <b>offline</b> - at least until I need it again.</p>
		</div>
	</body>
</html>
