...
<!-- Above here can be copied for a consistent header across pages -->
		<div id="page">
			...
			<p>At home I use a few IP cameras, mostly for remotely monitoring animals.  I have a combination of proprietary dedicated IP cams (stock and modified) and raspberry pis either pi-cams or usb web-cams.</p>
			...
			<p>The solution was to define the action button names and script commands in the add-on configuration yaml via the Home Assistant interface, and modify the motioneye initialisation script so that it would generate the action button script files when the container is started.</p>
