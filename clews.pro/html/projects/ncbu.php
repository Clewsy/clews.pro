...
<!-- Above here can be copied for a consistent header across pages -->
		<div id="page">
			...
			<div class="code">
				<p class="terminal">	$ git clone git@gitlab.com:clewsy/ncbu<br/>
							$ cd ncbu<br/>
							$ docker build -t ncbu/ncbu .</p>
			</div>
			<p>Pull from <a href="https://hub.docker.com/r/clewsy/ncbu">dockerhub</a>:</p>
			<div class="code">
				<p class="terminal">	$ docker pull clewsy/ncbu</p>
			</div>
			<hr/>
			...
			<div class="code">
				<p class="terminal">	$ docker run -ti \<br/>
							-h ncbu \<br/>
			...
			<div class="code">
				<p class="terminal">	$ cd /home/docker #Substitute directory for location of the docker-compose.yml file.<br/>
			...
			<div class="code">
				<p class="terminal">	$ docker logs ncbu</p>
			</div>
			<div class="code">
				<p class="terminal">	<b>2020-03-30 11:13:29</b> - Initialising ncbu (nextcloud-backup)...<br/>
			...
			<div class="code">
				<p class="terminal">	$ docker exec ncbu ncbu.sh</p>
			</div>
			<div class="code">
				<p class="terminal">	<b>2020-03-30 10:22:14</b> - Running ncbu (nextcloud backup)...<br/>
							...
							<b>2020-03-30 10:22:15</b> - All done.</p>
			</div>
			<hr/>

			<h4>Initiate restoration from a backup (with sample output):</h4>
			<div class="code">
				<p class="terminal">	$ docker exec ncbu ncbu_restore.sh</p>
			</div>
			<div class="code">
				<p class="terminal">	<b>2020-03-30 11:34:12</b> - Running ncbu restore...<br/>
			...
			<h1><center>...</center></h1>
			<div class="code">
				<p class="terminal">		&emsp;&emsp;&emsp;&emsp;Folder &nbsp; /jadon/files_versions/InstantUpload/Camera/2020/02<br/>
